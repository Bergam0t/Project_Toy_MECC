...
with open("./streamlit_app/outputs/session_data.json", "r") as f:
    session_data = json.load(f)

data_no_mecc = pd.read_csv("./streamlit_app/outputs/data_no_mecc.csv")
data_mecc = pd.read_csv("./streamlit_app/outputs/data_mecc.csv")
